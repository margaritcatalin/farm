package ro.piata.localmarket.config.aop;
...
public class LoggingAspect {
     ...
     */
    @Pointcut(
            "within(ro.piata.localmarket.core.repository..*)" +
                    " || within(ro.piata.localmarket.service..*)" +
                    " || within(ro.piata.localmarket.web.controllers..*)"
    )
