package ro.piata.localmarket.config.logging;
...
public final class LoggingUtils {
    ...
    public static void addLogstashTcpSocketAppender(LoggerContext context, String customFields, LocalMarketProperties.Logging.Logstash logstashProperties) {
    ...
    public static void addContextListener(LoggerContext context, String customFields, LocalMarketProperties.Logging properties) {
    ...
    private static class LogbackLoggerContextListener extends ContextAwareBase implements LoggerContextListener {
        private final LocalMarketProperties.Logging loggingProperties;
        private final String customFields;

        private LogbackLoggerContextListener(LocalMarketProperties.Logging loggingProperties, String customFields) {
