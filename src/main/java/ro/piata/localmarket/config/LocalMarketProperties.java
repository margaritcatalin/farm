...
public class LocalMarketProperties {
    ...
    public static class Cache {
        ...
        public static class Redis {
            ...
            public Redis() {
                this.server = ro.piata.localmarket.config.LocalMarketDefaults.Cache.Redis.server;
                this.expiration = 300;
                this.cluster = false;
    ...
    public static class Security {
        ...
        public static class ClientAuthorization {
            ...
            public ClientAuthorization() {
                this.accessTokenUri = ro.piata.localmarket.config.LocalMarketDefaults.Security.ClientAuthorization.accessTokenUri;
                this.tokenServiceId = ro.piata.localmarket.config.LocalMarketDefaults.Security.ClientAuthorization.tokenServiceId;
                this.clientId = ro.piata.localmarket.config.LocalMarketDefaults.Security.ClientAuthorization.clientId;
                this.clientSecret = ro.piata.localmarket.config.LocalMarketDefaults.Security.ClientAuthorization.clientSecret;
            }
        ...
        public static class Authentication {
            ...
            public static class Jwt {
                ...
                public Jwt() {
                    this.secret = ro.piata.localmarket.config.LocalMarketDefaults.Security.Authentication.Jwt.secret;
                    this.base64Secret = ro.piata.localmarket.config.LocalMarketDefaults.Security.Authentication.Jwt.base64Secret;
        ...
        public static class RememberMe {
            ...
            public RememberMe() {
                this.key = ro.piata.localmarket.config.LocalMarketDefaults.Security.RememberMe.key;
            }
    ...
    public static class Gateway {
        ...
        public Gateway() {
            this.authorizedMicroservicesEndpoints = ro.piata.localmarket.config.LocalMarketDefaults.Gateway.authorizedMicroservicesEndpoints;
        }
    ...
    public static class Registry {
        ...
        public Registry() {
            this.password = ro.piata.localmarket.config.LocalMarketDefaults.Registry.password;
        }
    ...
    public static class ClientApp {
        private String name = "localMarketApp";
